...
- [ ] 3.14a Implement read-only `adico list` and `adico view <item>` using configured registry resolution; verify default/explicit namespace selection, complete metadata output, and no consumer-project mutation.
