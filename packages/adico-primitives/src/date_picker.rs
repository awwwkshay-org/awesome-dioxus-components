...
/// ```rust
/// use dioxus::prelude::*;
/// use adico_primitives::{calendar::Calendar, date_picker::*, popover::*, ContentAlign};
/// use time::Date;
/// #[component]
/// fn Demo() -> Element {
...
/// ```rust
/// use dioxus::prelude::*;
/// use adico_primitives::{calendar::{DateRange, RangeCalendar}, date_picker::*, popover::*, ContentAlign};
/// #[component]
/// fn Demo() -> Element {
