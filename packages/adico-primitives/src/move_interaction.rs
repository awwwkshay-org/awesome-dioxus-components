...
// Upstream path: primitives/src/move_interaction.rs. See provenance/records/adico-primitives-wave2-risk.json.
//
// Ported unmodified. Its `get_client_rect()` calls only run from event/mount
