...
/// ```rust
/// use dioxus::prelude::*;
/// use adico_primitives::avatar::{Avatar, AvatarFallback, AvatarImage};
///
/// #[component]
/// fn Demo() -> Element {
///     rsx! {
...
fn use_cached_image_load_reconciliation(
    ...
    src: String,
    current_src: Signal<Option<String>>,
    ctx: AvatarCtx,
) {
    use_effect(use_reactive!(|src| {
        let watcher_src = src.clone();
        ...
        let mut event_current_src = current_src;
        spawn(async move {
...
fn use_cached_image_load_reconciliation(
    ...
    _src: String,
    _current_src: Signal<Option<String>>,
    _ctx: AvatarCtx,
) {
}
...
pub fn AvatarImage(props: AvatarImageProps) -> Element {
    ...
    use_cached_image_load_reconciliation(image_id, props.src.clone(), current_src, ctx.clone());
