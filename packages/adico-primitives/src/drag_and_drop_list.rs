...
// finish a native HTML5 pointer drag started from that same handler. Unlike
// the long-lived, effect-mounted `document::eval` listeners already found
// broken in this Dioxus 0.7.9/0.7.10 web runtime (`use_global_escape_listener`,
...
/// ```rust
///use dioxus::prelude::*;
///use adico_primitives::drag_and_drop_list::{DragAndDropList, DragAndDropListItem};
///#[component]
///pub fn Demo() -> Element {
